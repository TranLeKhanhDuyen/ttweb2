		...
		<div class="row p-2">
			<div class="col-md-6">
				...
				<div class="card bg-white">
					<div class="card-body">
						<h3 class="text-center text-success">Your Sellect Items:</h3>
						<table class="table table-striped">
							...
							<tbody>
								...
								List<Cart> cart = dao.getBagByUser(u.getId());
								Double totalPrice = 0.00;
								for (Cart c : cart) {
									totalPrice = c.getTotalPrice();
								%>
								<tr>
									<th scope="row"><%=c.getBagName()%></th>
									<td><%=c.getPrice()%></td>
									<td><a href="remove_bag?bid=<%=c.getBid()%>&&uid=<%=c.getUserId()%>&&cid=<%=c.getCid() %>"
				...
				<div class="card">
					<div class="card-body">
						...
						<input type="hidden" value="${userobj.id}" name="id">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Province</label> <input type="text" name="landmark"
										class="form-control" id="inputEmail4"  required>
								</div>
								<div class="form-group col-md-6">
									<label for="inputPassword4">District</label> <input type="text" name="city"
										class="form-control" id="inputPassword4" required>
								</div>
							</div>
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Wards</label> <input type="text" name="state"
										class="form-control" id="inputEmail4" required >
								</div>
								<div class="form-group col-md-6">
