		...
		<c:if test="${not empty userobj}">
			<div class="col-md-3">
				...
				<a href="checkout.jsp"><i
					class="fa-solid fa-cart-plus fa-2x mt-1"></i></a> <a href="login.jsp"
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link"
				href="all_featured_bag.jsp"> Featured Bags</a></li>
			<li class="nav-item active"><a class="nav-link"
				href="all_new_bag.jsp"> New Bags</a></li>

			<li class="nav-item active"><a class="nav-link disabled"
				href="all_old_bag.jsp">Old Bags</a></li>
		</ul>
		<form class="form-inline my-2 my-lg-0">
			<a href="setting.jsp" class="btn btn-light my-2 my-sm-0"
				type="submit"> <i class="fa-solid fa-gear"></i>
			</a>
